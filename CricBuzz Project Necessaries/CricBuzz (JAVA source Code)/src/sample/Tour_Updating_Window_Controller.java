...
public class Tour_Updating_Window_Controller {

    @FXML
    Button Back_Button;

    @FXML
    Button Add_A_Match_Button;
    ...
    public void Add_A_Match_Button_Clicked(ActionEvent actionEvent)
    {
        Tour tour = (Tour)Tour_Search_list_tableview.getSelectionModel().getSelectedItem();
        ...
        if(tour==null)
        {
            try {
                ...
                alert1.setContentText("Please Select A Tour");
        ...
        try {
            ...
            loader.setLocation(getClass().getResource("Match_Adding_For_Tournament.fxml"));
            Parent root2 = loader.load();
            Match_Adding_For_Tournament_Controller controller=loader.getController();
            controller.init(tour);

            Main.stage.setTitle("FIX A MATCH");
            Main.stage.setScene(new Scene(root2, 803, 547));
            Main.stage.show();
